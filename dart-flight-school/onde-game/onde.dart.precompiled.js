...
"":"Tp:11;",
call$1:function(a){var z=J.x(a)
return typeof a==="object"&&a!==null&&!!z.$iscv}}}],["","file:///Users/tiagojesus/Desktop/onde-game/web/onde.dart",,Y,{
"":"",
Iq:[function(){var z=J.Vg(document.querySelector("#novoBtn"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new Y.em()),z.Sg),[H.Kp(z,0)]).Zz()},"call$0","eE",0,0,8],
kL:function(){var z,y,x,w,v,u,t,s,r,q
$.dZ=!0
$.WS=0
$.CM=C.jn.bu(C.pr.j1($.ow))
z=document.querySelector("#tabuleiro")
y=J.RE(z)
y.gwd(z).V1(0)
for(x=0;x<$.ow;++x){w=y.gwd(z)
v=document.createElement("li",null)
u=J.RE(v)
u.gDD(v).h(0,"item")
v.setAttribute("data-index",C.jn.bu(x))
t=u.gVl(v)
s=t.Ph
r=t.Sg
q=new W.xC(0,t.uv,s,W.VF(Y.Lt()),r)
...
if(!$.dZ)return
z=J.iz(J.BC(a),"data-index")
$.WS=$.WS+1
y=$.CM
x=a.currentTarget
if(z===y){Y.lv(W.qc(x),!0)
document.querySelector("#mensagem").textContent="Voc\u00ea ganhou"
$.dZ=!1}else{Y.lv(W.qc(x),!1)
if($.WS>=2){document.querySelector("#mensagem").textContent="Voc\u00ea Perdeu"
$.dZ=!1}}},"call$1","Lt",2,0,9],
lv:function(a,b){var z=J.RE(a)
if(b){z.gDD(a).h(0,"item-acertou")
a.firstChild.textContent="parab\u00e9ns"}else{z.gDD(a).h(0,"item-aberto")
a.firstChild.textContent="ops"}},
em:{
"":"Tp:11;",
call$1:function(a){return Y.kL()}}},1],])
...
init.metadata=[{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"XF",args:[W.Aj]},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"zx",args:[J.O]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
em.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,n6,Ny,nx,QQ,fW,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,Wq,cm,Nh,cv,Fs,Ty,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,xn,Vb,QH,ST,X2,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,SP,r0,nK,yp,c1,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,xL,es,jw,bd,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,ox,ZD,vt,wD,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,ET,V6,FK,Gv,kn,YE,MF,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,cu,dC,wN,VX,a7,i1,xy,MH,U5,SO,SU,Ca,b8,vs,da,xw,dm,rH,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,Kd,UO,Bc,VT,Fj,q1,Zz,ly,QW,u8,yU,nP,KA,qB,ez,fI,LV,dp,B3,CR,Qk,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,VG,zL,ec,e7,dx,kE,hm,x5,I4,Fk,RO,eu,xC,Pb,W9,dW,O7,mg,b0,Pg,Ob,GV,As,GE,D7,Zf,em]}